...
export function Tree({ size = 56, variant = 'oak' }) {
  if (variant === 'pine') {
    return (
      <Svg width={size} height={size} viewBox="0 0 40 56">
        ...
        <Ellipse cx={20} cy={20} rx={14} ry={18} fill={FIZTEX.greenDeep} />
        <Ellipse cx={20} cy={16} rx={11} ry={14} fill={FIZTEX.green} />
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 48 56">
      ...
      <Circle cx={24} cy={22} r={18} fill={FIZTEX.greenDeep} />
      <Circle cx={14} cy={20} r={12} fill={FIZTEX.green} />
      <Circle cx={34} cy={20} r={12} fill={FIZTEX.green} />
